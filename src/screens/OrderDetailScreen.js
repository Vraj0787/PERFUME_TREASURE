        ...
        {loading ? (
          ...
          <View style={styles.contentWrap}>
            ...
            <View style={styles.card}>
              ...
              {(order.items || []).map(item => (
                <View key={item.id} style={styles.itemRow}>
                  ...
                  <Text style={styles.itemPrice}>${Number(item.unit_price || 0).toFixed(2)}</Text>
                </View>
              ))}
            </View>
            ...
            <View style={styles.card}>
              ...
              <Text style={styles.totalText}>Total: ${Number(order.total_amount || 0).toFixed(2)}</Text>
              <Text style={styles.pointsText}>Points Earned: {Number(order.points_earned || 0)}</Text>
            </View>
          </View>
        ) : null}
      </ScrollView>
