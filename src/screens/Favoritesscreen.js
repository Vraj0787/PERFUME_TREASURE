...
function FavoritesScreen({navigation, onAddToCart, favoritesIds, onToggleFavorite}) {
  ...
  const favoritedProducts = allProducts.filter(product => favoritesIds.includes(product.id));
        ...
        {loading ? (
          ...
          <>
            <Text style={styles.resultsSubtitle}>
              {favoritedProducts.length} saved fragrance{favoritedProducts.length === 1 ? '' : 's'}
            </Text>
