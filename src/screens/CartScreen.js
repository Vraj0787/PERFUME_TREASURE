        ...
        {loading ? (
          ...
          <View style={styles.stateWrap}>
            ...
            <Text style={styles.stateText}>
              Add fragrances from the collection to continue.
            </Text>
          </View>
        ) : (
          <View style={styles.contentWrap}>
            ...
            <View style={styles.summaryCard}>
              <Text style={styles.summaryRow}>
                Subtotal: ${Number(cart.totals?.subtotal || 0).toFixed(2)}
              </Text>
              <Text style={styles.summaryRow}>
                Shipping: ${Number(cart.totals?.shipping_amount || 0).toFixed(2)}
              </Text>
              <Text style={styles.summaryRow}>
                Tax: ${Number(cart.totals?.tax_amount || 0).toFixed(2)}
              </Text>
              <Text style={styles.summaryTotal}>
                Total: ${Number(cart.totals?.total_amount || 0).toFixed(2)}
              </Text>
            </View>
